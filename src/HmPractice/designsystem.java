...
public class designsystem {
	...
	public static void main(String[]args) {
		...
		List<WebElement> componentsIsEnabled = driver.findElements(By.xpath("//input[@class='usa-radio__input']"));
		WebElement ce = null;
		...
		List<WebElement> componentsIsDisplayed = driver.findElements(By.xpath("//legend[@class='usa-legend usa-legend']"));
		WebElement cd = null;
